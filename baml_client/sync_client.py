...
class BamlSyncClient:
    ...
    def CreateLessonPlan(self, topic: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="CreateLessonPlan", args={
                "topic": topic,
            })
    ...
    def EvaluateLessonPlan(self, topic: str,lessonPlan: types.LessonPlan,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="EvaluateLessonPlan", args={
...
class BamlStreamClient:
    ...
    def CreateLessonPlan(self, topic: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.LessonPlan, types.LessonPlan]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="CreateLessonPlan", args={
            "topic": topic,
        })
        return baml_py.BamlSyncStream[stream_types.LessonPlan, types.LessonPlan](
          result,
    ...
    def EvaluateLessonPlan(self, topic: str,lessonPlan: types.LessonPlan,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.LessonPlanEvaluation, types.LessonPlanEvaluation]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvaluateLessonPlan", args={
            "topic": topic,"lessonPlan": lessonPlan,
        })
        return baml_py.BamlSyncStream[stream_types.LessonPlanEvaluation, types.LessonPlanEvaluation](
          result,
...
class BamlHttpRequestClient:
    ...
    def CreateLessonPlan(self, topic: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="CreateLessonPlan", args={
            "topic": topic,
        }, mode="request")
        return result
    def EvaluateLessonPlan(self, topic: str,lessonPlan: types.LessonPlan,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvaluateLessonPlan", args={
            "topic": topic,"lessonPlan": lessonPlan,
        }, mode="request")
        return result
